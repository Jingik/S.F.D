...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "https://J11B103.p.ssafy.io")); // 도메인을 명시적으로 지정
        configuration.setAllowedOriginPatterns(List.of("http://localhost:3000", "https://J11B103.p.ssafy.io")); // 패턴으로 허용할 도메인들
